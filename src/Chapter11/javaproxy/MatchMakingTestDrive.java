...
public class MatchMakingTestDrive {
	...
	public void drive() {
		Person moon = getPersonFromDatabase("김자바");
		Person ownerProxy = getOwnerProxy(moon);
		System.out.println("이름: " + ownerProxy.getName());
		ownerProxy.setInterests("볼링, 바둑");
		System.out.println("본인 프록시에는 관심 사하을 등록합니다.");
		try {
		...
		Person nonOwnerProxy = getNonOwnerProxy(moon);
